...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      href: 'https://www.linkedin.com/in/krishnakanth-j-517a9032a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
          ...
          <div className="space-y-10">
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-6">
                {[
                  { icon: Linkedin, href: "https://www.linkedin.com/in/krishnakanth-j-517a9032a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app", color: "from-blue-600 to-blue-700", hoverColor: "hover:shadow-blue-500/25" },
                  { icon: Github, href: "https://github.com/krishnakanth47", color: "from-gray-800 to-gray-900", hoverColor: "hover:shadow-gray-500/25" },

        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-2 text-primary">
              ...
              <span className="text-sm font-medium">Driven by curiosity, guided by creativity.</span>
            </div>
          </div>
            ...
            <div className="space-y-3">
              <div className="p-4 bg-white/5 rounded-xl backdrop-blur-sm border border-white/10">
                ...
                <div className="mt-3 flex items-center space-x-2">
                  ...
                  <p className="text-accent font-medium">Graduating in 2028</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2 text-gray-300">
              <span className="text-lg">A Digital Space</span>  

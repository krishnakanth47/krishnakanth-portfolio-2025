        ...
        <div className="animate-fade-in delay-200 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16 animate-fade-in delay-700">
            ...
            <Button 
              ...
              asChild
            >
              <a href="/resume.pdf" download="Krishnakanth_J_Resume.pdf">
          ...
          <div className="flex justify-center space-x-8 mb-16 animate-fade-in delay-1000">
            {[
              { icon: Linkedin, href: "https://www.linkedin.com/in/krishnakanth-j-517a9032a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app", color: "hover:bg-blue-500", bgGradient: "from-blue-500/20 to-blue-600/20" },
              { icon: Github, href: "https://github.com/krishnakanth47", color: "hover:bg-gray-800", bgGradient: "from-gray-700/20 to-gray-900/20" },
